...
const stats = [
  { icon: Shield, title: "ISO 9001 Certified", description: "Every product meets rigorous international quality standards with full traceability." },
  { icon: Package, title: "MOQ from 50 Units", description: "Minimum order quantities starting from 50 units, with bulk pricing for larger orders." },
  { icon: Globe, title: "60+ Countries", description: "Shipping worldwide with reliable logistics, customs documentation, and OEM branding." },
  { icon: Award, title: "15+ Years Experience", description: "Over a decade of manufacturing excellence based in Ningbo, Zhejiang, China." },
];
            ...
            {stats.map((stat) => {
              ...
              return (
                <StaggerItem key={stat.title}>
                  <div className="rounded-lg border border-border-primary bg-bg-primary p-6 transition-all hover:border-border-accent hover:shadow-[0_0_30px_rgba(244,196,48,0.05)]">
            ...
            {categories.map((cat) => (
              <StaggerItem key={cat._id}>
                <Link
                  ...
                  className="group flex items-center justify-between rounded-lg border border-border-primary bg-bg-card p-5 transition-all hover:border-border-accent hover:shadow-[0_0_20px_rgba(244,196,48,0.05)]"
                >
                  <div>
